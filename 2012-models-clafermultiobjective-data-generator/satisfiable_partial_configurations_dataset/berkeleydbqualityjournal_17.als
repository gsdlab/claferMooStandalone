...
{}
{ ((((((some this.@r_c6_HAVE_STATISTICS) && (some this.@r_c22_HAVE_CRYPTO)) && (some this.@r_c38_HAVE_INDEXES)) && (some (this.@r_c38_HAVE_INDEXES).@r_c118_HAVE_QUEUE)) && (no this.@r_c134_HAVE_REPLICATION)) && (some this.@r_c166_DIAGNOSTIC)) && (some this.@r_c182_HAVE_SEQUENCE) }
