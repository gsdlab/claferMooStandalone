...
{}
{ (((some this.@r_c22_HAVE_CRYPTO) && (no ((this.@r_c38_HAVE_INDEXES).@r_c54_HAVE_BTREE).@r_c70_BTREE_FAST)) && (no (this.@r_c38_HAVE_INDEXES).@r_c118_HAVE_QUEUE)) && (no this.@r_c134_HAVE_REPLICATION) }
