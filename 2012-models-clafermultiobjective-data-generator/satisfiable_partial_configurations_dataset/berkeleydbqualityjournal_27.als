...
{}
{ (((((((some this.@r_c22_HAVE_CRYPTO) && (some ((this.@r_c38_HAVE_INDEXES).@r_c54_HAVE_BTREE).@r_c86_BTREE_SMALL)) && (some (this.@r_c38_HAVE_INDEXES).@r_c102_HAVE_HASH)) && (no (this.@r_c38_HAVE_INDEXES).@r_c118_HAVE_QUEUE)) && (no this.@r_c134_HAVE_REPLICATION)) && (some this.@r_c150_HAVE_VERIFY)) && (some this.@r_c166_DIAGNOSTIC)) && (some this.@r_c182_HAVE_SEQUENCE) }
