...
{}
{ (((((((no this.@r_c6_HAVE_STATISTICS) && (some this.@r_c22_HAVE_CRYPTO)) && (some (this.@r_c38_HAVE_INDEXES).@r_c102_HAVE_HASH)) && (some (this.@r_c38_HAVE_INDEXES).@r_c118_HAVE_QUEUE)) && (no this.@r_c134_HAVE_REPLICATION)) && (some this.@r_c150_HAVE_VERIFY)) && (no this.@r_c166_DIAGNOSTIC)) && (no this.@r_c182_HAVE_SEQUENCE) }
