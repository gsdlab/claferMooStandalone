...
{}
{ ((((((some this.@r_c6_HAVE_STATISTICS) && (some (this.@r_c38_HAVE_INDEXES).@r_c54_HAVE_BTREE)) && (no ((this.@r_c38_HAVE_INDEXES).@r_c54_HAVE_BTREE).@r_c70_BTREE_FAST)) && (some ((this.@r_c38_HAVE_INDEXES).@r_c54_HAVE_BTREE).@r_c86_BTREE_SMALL)) && (no (this.@r_c38_HAVE_INDEXES).@r_c102_HAVE_HASH)) && (no this.@r_c134_HAVE_REPLICATION)) && (no this.@r_c182_HAVE_SEQUENCE) }
