...
{}
{ ((((((some this.@r_c6_HAVE_STATISTICS) && (some this.@r_c38_HAVE_INDEXES)) && (some (this.@r_c38_HAVE_INDEXES).@r_c54_HAVE_BTREE)) && (some ((this.@r_c38_HAVE_INDEXES).@r_c54_HAVE_BTREE).@r_c86_BTREE_SMALL)) && (some (this.@r_c38_HAVE_INDEXES).@r_c102_HAVE_HASH)) && (some this.@r_c134_HAVE_REPLICATION)) && (no this.@r_c182_HAVE_SEQUENCE) }
